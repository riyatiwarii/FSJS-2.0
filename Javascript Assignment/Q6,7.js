...
let stringVar = 'Facebook, Google, Microsoft, Apple, IBM, Oracle, Amazon';
console.log(stringVar.split(","))

// Determining the position of the first and last occurrence of a word "pw skills" using lastIndexOf in an array
